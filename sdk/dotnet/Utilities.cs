...
namespace Pulumi.CloudNgfwAws
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumi/pulumi-cloudngfwaws";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.CloudNgfwAws.version.txt");
    ...
    internal sealed class CloudNgfwAwsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CloudNgfwAwsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
