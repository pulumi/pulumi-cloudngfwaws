...
public final class GetRulestackPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRulestackPlainArgs Empty = new GetRulestackPlainArgs();
    ...
    private GetRulestackPlainArgs() {}

    private GetRulestackPlainArgs(GetRulestackPlainArgs $) {
    ...
    public static Builder builder(GetRulestackPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRulestackPlainArgs();
        }

        public Builder(GetRulestackPlainArgs defaults) {
            $ = new GetRulestackPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRulestackPlainArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetRulestackPlainArgs", "name");
            }
            return $;
        }
    }
