...
public final class CommitRulestackArgs extends com.pulumi.resources.ResourceArgs {

    public static final CommitRulestackArgs Empty = new CommitRulestackArgs();
    ...
    private CommitRulestackArgs() {}

    private CommitRulestackArgs(CommitRulestackArgs $) {
    ...
    public static Builder builder(CommitRulestackArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CommitRulestackArgs();
        }

        public Builder(CommitRulestackArgs defaults) {
            $ = new CommitRulestackArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CommitRulestackArgs build() {
            if ($.rulestack == null) {
                throw new MissingRequiredPropertyException("CommitRulestackArgs", "rulestack");
            }
            return $;
        }
    }
