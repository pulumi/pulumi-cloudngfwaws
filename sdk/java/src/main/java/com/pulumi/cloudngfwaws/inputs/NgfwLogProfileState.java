...
public final class NgfwLogProfileState extends com.pulumi.resources.ResourceArgs {

    public static final NgfwLogProfileState Empty = new NgfwLogProfileState();
    ...
    public static Builder builder(NgfwLogProfileState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NgfwLogProfileState();
        }

        public Builder(NgfwLogProfileState defaults) {
            $ = new NgfwLogProfileState(Objects.requireNonNull(defaults));
        }
