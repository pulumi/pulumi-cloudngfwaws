...
public final class GetFqdnListPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFqdnListPlainArgs Empty = new GetFqdnListPlainArgs();
    ...
    private GetFqdnListPlainArgs() {}

    private GetFqdnListPlainArgs(GetFqdnListPlainArgs $) {
    ...
    public static Builder builder(GetFqdnListPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFqdnListPlainArgs();
        }

        public Builder(GetFqdnListPlainArgs defaults) {
            $ = new GetFqdnListPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFqdnListPlainArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetFqdnListPlainArgs", "name");
            }
            if ($.rulestack == null) {
                throw new MissingRequiredPropertyException("GetFqdnListPlainArgs", "rulestack");
            }
            return $;
        }
    }
