...
public final class GetFqdnListArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFqdnListArgs Empty = new GetFqdnListArgs();
    ...
    private GetFqdnListArgs() {}

    private GetFqdnListArgs(GetFqdnListArgs $) {
    ...
    public static Builder builder(GetFqdnListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetFqdnListArgs defaults) {
            $ = new GetFqdnListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFqdnListArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetFqdnListArgs", "name");
            }
            if ($.rulestack == null) {
                throw new MissingRequiredPropertyException("GetFqdnListArgs", "rulestack");
            }
            return $;
        }
    }
