...
public final class GetCustomUrlCategoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetCustomUrlCategoryArgs Empty = new GetCustomUrlCategoryArgs();
    ...
    private GetCustomUrlCategoryArgs() {}

    private GetCustomUrlCategoryArgs(GetCustomUrlCategoryArgs $) {
    ...
    public static Builder builder(GetCustomUrlCategoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCustomUrlCategoryArgs();
        }

        public Builder(GetCustomUrlCategoryArgs defaults) {
            $ = new GetCustomUrlCategoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCustomUrlCategoryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetCustomUrlCategoryArgs", "name");
            }
            if ($.rulestack == null) {
                throw new MissingRequiredPropertyException("GetCustomUrlCategoryArgs", "rulestack");
            }
            return $;
        }
    }
