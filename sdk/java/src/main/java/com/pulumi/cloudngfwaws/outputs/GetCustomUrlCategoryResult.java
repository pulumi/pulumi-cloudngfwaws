...
@CustomType
public final class GetCustomUrlCategoryResult {
    /**
     * @return The action to take. Valid values are `none`, `alert`, `allow`, `block`, `continue`, or `override`.
     * 
     */
    ...
    public static Builder builder(GetCustomUrlCategoryResult defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> urlLists;
        public Builder() {}
        public Builder(GetCustomUrlCategoryResult defaults) {
        ...
        public Builder action(String action) {
            if (action == null) {
              throw new MissingRequiredPropertyException("GetCustomUrlCategoryResult", "action");
            }
            this.action = action;
            return this;
        }
        ...
        public Builder auditComment(String auditComment) {
            if (auditComment == null) {
              throw new MissingRequiredPropertyException("GetCustomUrlCategoryResult", "auditComment");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetCustomUrlCategoryResult", "description");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCustomUrlCategoryResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCustomUrlCategoryResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder rulestack(String rulestack) {
            if (rulestack == null) {
              throw new MissingRequiredPropertyException("GetCustomUrlCategoryResult", "rulestack");
            }
        ...
        public Builder updateToken(String updateToken) {
            if (updateToken == null) {
              throw new MissingRequiredPropertyException("GetCustomUrlCategoryResult", "updateToken");
            }
        ...
        public Builder urlLists(List<String> urlLists) {
            if (urlLists == null) {
              throw new MissingRequiredPropertyException("GetCustomUrlCategoryResult", "urlLists");
            }
        ...
        public GetCustomUrlCategoryResult build() {
            final var _resultValue = new GetCustomUrlCategoryResult();
            ...
            _resultValue.urlLists = urlLists;
            return _resultValue;
        }
    }
}
