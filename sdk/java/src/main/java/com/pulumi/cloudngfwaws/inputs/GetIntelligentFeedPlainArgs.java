...
public final class GetIntelligentFeedPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetIntelligentFeedPlainArgs Empty = new GetIntelligentFeedPlainArgs();
    ...
    private GetIntelligentFeedPlainArgs() {}

    private GetIntelligentFeedPlainArgs(GetIntelligentFeedPlainArgs $) {
    ...
    public static Builder builder(GetIntelligentFeedPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIntelligentFeedPlainArgs();
        }

        public Builder(GetIntelligentFeedPlainArgs defaults) {
            $ = new GetIntelligentFeedPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetIntelligentFeedPlainArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetIntelligentFeedPlainArgs", "name");
            }
            if ($.rulestack == null) {
                throw new MissingRequiredPropertyException("GetIntelligentFeedPlainArgs", "rulestack");
            }
            return $;
        }
    }
